            ...
            <tr class="hover:bg-gray-50">
                <td class="px-5 py-4">
                    <div class="flex items-center gap-3">
                        ...
                        @else
                            <div class="w-9 h-9 bg-gray-100 rounded-xl flex items-center justify-center text-gray-400">📦</div>
                        @endif
                        <div>
                ...
                <td class="px-5 py-4 text-gray-500 text-xs">{{ $product->vendor?->company_name }}</td>
                <td class="px-5 py-4 text-gray-500 text-xs">{{ $product->category?->name }}</td>
                <td class="px-5 py-4 text-gray-700 font-medium">${{ $product->price ? number_format($product->price, 2) : '—' }}</td>
                <td class="px-5 py-4">
                ...
                <td class="px-5 py-4 text-right">
                    <a href="{{ route('admin.products.edit', $product) }}" class="text-xs text-green-600 hover:text-blue-800 font-medium mr-3">Edit</a>
