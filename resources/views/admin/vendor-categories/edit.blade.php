...
<div class="max-w-xl">
    <div class="mb-6">
        <a href="{{ route('admin.vendor-categories.index') }}" class="text-sm text-secondary/50 hover:text-secondary/70">← Back</a>
    </div>
    <div class="bg-white rounded-xl border border-secondary/5 shadow-sm p-6">
        <h2 class="font-bold text-secondary text-lg mb-6">Edit: {{ $vendorCategory->name }}</h2>
