        ...
        <div class="flex flex-col lg:flex-row gap-12 lg:gap-16">
            ...
            <div class="lg:w-1/3 flex flex-col gap-6">
                ...
                <div class="bg-white p-10 rounded-[40px] shadow-xl border border-slate-200 group hover:-translate-y-1 transition-all duration-300">
                    <div class="w-14 h-14 bg-green-600 rounded-2xl flex items-center justify-center text-white mb-6 shadow-lg shadow-green-600/30 group-hover:scale-110 transition-transform">
                        <i class="fas fa-envelope text-xl"></i>
                    </div>
                    <h4 class="text-xl font-black mb-2 text-slate-900">Email Us</h4>
                    <a href="mailto:info@b2bmarketplace.com" class="text-green-600 font-bold text-lg mb-1 block hover:underline">info@b2bmarketplace.com</a>
                ...
                <div class="bg-white p-10 rounded-[40px] shadow-xl border border-slate-200 group hover:-translate-y-1 transition-all duration-300">
                    ...
                    <a href="tel:+11234567890" class="text-green-600 font-bold text-lg mb-1 block hover:underline">+1 (123) 456-7890</a>
                ...
                <div class="bg-white p-10 rounded-[40px] shadow-xl border border-slate-200 group hover:-translate-y-1 transition-all duration-300">
                    ...
                    <div class="flex items-center gap-3 mt-4">
                        <a href="#" aria-label="Facebook" class="w-10 h-10 rounded-xl bg-slate-100 border border-slate-200 flex items-center justify-center text-slate-600 hover:bg-green-600 hover:border-green-600 hover:text-white transition-all duration-300">
                            <i class="fab fa-facebook-f text-sm"></i>
                        </a>
                        <a href="#" aria-label="Twitter" class="w-10 h-10 rounded-xl bg-slate-100 border border-slate-200 flex items-center justify-center text-slate-600 hover:bg-green-600 hover:border-green-600 hover:text-white transition-all duration-300">
                            <i class="fab fa-twitter text-sm"></i>
                        </a>
                        <a href="#" aria-label="LinkedIn" class="w-10 h-10 rounded-xl bg-slate-100 border border-slate-200 flex items-center justify-center text-slate-600 hover:bg-green-600 hover:border-green-600 hover:text-white transition-all duration-300">
                            <i class="fab fa-linkedin-in text-sm"></i>
                        </a>
                        <a href="#" aria-label="Instagram" class="w-10 h-10 rounded-xl bg-slate-100 border border-slate-200 flex items-center justify-center text-slate-600 hover:bg-green-600 hover:border-green-600 hover:text-white transition-all duration-300">
                ...
                <div class="bg-white p-10 rounded-[40px] shadow-xl border border-slate-200 group hover:-translate-y-1 transition-all duration-300">
                    ...
                    <p class="text-green-600 font-bold text-base mb-1 leading-snug">123 Business Plaza,<br>Trade Center, Suite 456</p>
            ...
            <div class="lg:w-2/3">
                <div class="bg-white p-10 lg:p-16 rounded-[50px] shadow-xl border border-slate-200">
                    <div class="mb-10">
                        <span class="text-green-600 font-bold uppercase tracking-[0.2em] text-xs mb-3 block">Send us a message</span>
                        <h2 class="text-3xl sm:text-4xl lg:text-5xl font-heading font-black text-slate-900 leading-tight">
                            Let's Start a <span class="bg-gradient-to-r from-green-600 to-emerald-700 bg-clip-text text-transparent italic">Conversation</span>
                        </h2>
                    </div>
                    
                    @if(session('success'))
                        <div class="mb-6 p-4 bg-green-100 border border-green-200 text-green-800 rounded-2xl text-sm">
                    ...
                    <form method="POST" action="{{ route('contact.store') }}" class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="space-y-2">
                                ...
                                <input type="text" name="name" value="{{ old('name') }}" required
                                       class="w-full bg-slate-50 border-2 border-slate-200 rounded-3xl py-5 px-8 focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all text-slate-900 font-medium text-sm"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="space-y-2">
                                ...
                                <select name="subject" required
                                        class="w-full bg-slate-50 border-2 border-slate-200 rounded-3xl py-5 px-8 focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all text-slate-900 font-medium text-sm cursor-pointer">
                        ...
                        <div class="space-y-2">
                            ...
                            <textarea name="message" rows="6" required
                                      class="w-full bg-slate-50 border-2 border-slate-200 rounded-3xl py-5 px-8 focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all text-slate-900 font-medium text-sm resize-none"
                        ...
                        <div class="pt-4">
                            <button type="submit"
                                    class="group relative px-12 py-5 bg-gradient-to-r from-green-600 to-emerald-700 text-white rounded-full font-black text-sm uppercase tracking-widest hover:from-blue-700 hover:to-indigo-700 transition-all shadow-xl shadow-green-600/30 flex items-center gap-3 overflow-hidden">
...
{{-- ═══════════════════════════════════════════════
     QUICK STATS
═══════════════════════════════════════════════ --}}
<section class="py-16 bg-gradient-to-br from-slate-900 via-green-900 to-slate-900 text-white relative overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-8 text-center">
            ...
            <div class="group">
                <div class="w-12 h-12 bg-white/5 border border-white/10 rounded-xl flex items-center justify-center text-amber-300 mx-auto mb-4 group-hover:bg-green-600 group-hover:border-green-600 transition-all">
...
<section class="py-20 lg:py-32 bg-white">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16">
            <span class="text-green-600 font-bold uppercase tracking-[0.2em] text-xs mb-4 block">Common Questions</span>
            <h2 class="text-4xl sm:text-5xl font-heading font-black text-slate-900 leading-none">
                Frequently Asked <span class="bg-gradient-to-r from-green-600 to-emerald-700 bg-clip-text text-transparent italic">Questions</span>
            </h2>
        </div>
        ...
        <div class="space-y-4">
            ...
            <details class="group bg-slate-50 rounded-2xl border border-slate-200 overflow-hidden hover:border-green-200 transition-colors">
                <summary class="flex items-center justify-between cursor-pointer p-6 font-bold text-slate-900 text-sm">
                    <span>{{ $question }}</span>
                    <i class="fas fa-chevron-down text-green-600 text-xs group-open:rotate-180 transition-transform"></i>
                </summary>
        ...
        <div class="mt-12 text-center p-8 bg-green-50 rounded-3xl border border-green-100">
            ...
            <a href="mailto:info@b2bmarketplace.com" class="inline-flex items-center gap-2 px-8 py-3 bg-green-600 text-white font-bold text-sm rounded-full hover:bg-green-700 transition-all">
