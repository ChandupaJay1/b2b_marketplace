    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div class="max-w-4xl mx-auto text-center">
            ...
            <h1 class="text-5xl sm:text-6xl lg:text-8xl font-heading font-black text-white leading-[0.9] mb-6 tracking-tight">
                Contact <br><span class="bg-gradient-to-r from-accent to-accent-dark bg-clip-text text-transparent italic">Us</span>
            </h1>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div class="flex flex-col lg:flex-row gap-12 lg:gap-16">
            ...
            <div class="lg:w-1/3 flex flex-col gap-6">
                {{-- Email Card --}}
                <div class="bg-white p-10 rounded-[40px] shadow-xl border border-secondary/20 group hover:-translate-y-1 transition-all duration-300">
                    ...
                    <p class="text-secondary/70 text-xs font-medium">Available Mon – Fri, 9am to 6pm</p>
                </div>
                ...
                <div class="bg-white p-10 rounded-[40px] shadow-xl border border-secondary/20 group hover:-translate-y-1 transition-all duration-300">
                    ...
                    <h4 class="text-xl font-black mb-2 text-secondary">Call Us</h4>
                    ...
                    <p class="text-secondary/70 text-xs font-medium">Mon – Fri, 9am to 6pm (EST)</p>
                </div>
                ...
                <div class="bg-white p-10 rounded-[40px] shadow-xl border border-secondary/20 group hover:-translate-y-1 transition-all duration-300">
                    ...
                    <div class="flex items-center gap-3 mt-4">
                        <a href="#" aria-label="Facebook" class="w-10 h-10 rounded-xl bg-surface border border-secondary/20 flex items-center justify-center text-secondary/70 hover:bg-primary hover:border-primary hover:text-white transition-all duration-300">
                            <i class="fab fa-facebook-f text-sm"></i>
                        </a>
                        <a href="#" aria-label="Twitter" class="w-10 h-10 rounded-xl bg-surface border border-secondary/20 flex items-center justify-center text-secondary/70 hover:bg-primary hover:border-primary hover:text-white transition-all duration-300">
                            <i class="fab fa-twitter text-sm"></i>
                        </a>
                        <a href="#" aria-label="LinkedIn" class="w-10 h-10 rounded-xl bg-surface border border-secondary/20 flex items-center justify-center text-secondary/70 hover:bg-primary hover:border-primary hover:text-white transition-all duration-300">
                            <i class="fab fa-linkedin-in text-sm"></i>
                        </a>
                        <a href="#" aria-label="Instagram" class="w-10 h-10 rounded-xl bg-surface border border-secondary/20 flex items-center justify-center text-secondary/70 hover:bg-primary hover:border-primary hover:text-white transition-all duration-300">
                            <i class="fab fa-instagram text-sm"></i>
                        </a>
                    </div>
                    <p class="text-secondary/70 text-xs font-medium mt-3">We respond within 24 hours</p>
                </div>
                ...
                <div class="bg-white p-10 rounded-[40px] shadow-xl border border-secondary/20 group hover:-translate-y-1 transition-all duration-300">
                    ...
                    <h4 class="text-xl font-black mb-2 text-secondary">Visit Us</h4>
                    <p class="text-primary font-bold text-base mb-1 leading-snug">Kada 50, Viskam Piyasa<br>Anuradhapura</p>
                    <p class="text-secondary/70 text-xs font-medium">View on Google Maps</p>
                </div>
            </div>

            {{-- Contact Form --}}
            <div class="lg:w-2/3">
                <div class="bg-white p-10 lg:p-16 rounded-[50px] shadow-xl border border-secondary/20">
                    <div class="mb-10">
                    ...
                    @if(session('success'))
                        <div class="mb-6 p-4 bg-primary/10 border border-primary/20 text-primary-dark rounded-2xl text-sm">
                    ...
                    <form method="POST" action="{{ route('contact.store') }}" class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="space-y-2">
                                <label class="text-xs font-bold text-secondary/70 ml-4 uppercase tracking-wider">Your Name *</label>
                                <input type="text" name="name" value="{{ old('name') }}" required
                                       class="w-full bg-surface border-2 border-secondary/20 rounded-3xl py-5 px-8 focus:ring-2 focus:ring-primary/50 focus:border-transparent transition-all text-secondary font-medium text-sm"
                            ...
                            <div class="space-y-2">
                                <label class="text-xs font-bold text-secondary/70 ml-4 uppercase tracking-wider">Business Email *</label>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="space-y-2">
                                <label class="text-xs font-bold text-secondary/70 ml-4 uppercase tracking-wider">Phone Number</label>
                            ...
                            <div class="space-y-2">
                                <label class="text-xs font-bold text-secondary/70 ml-4 uppercase tracking-wider">Subject *</label>
                                <select name="subject" required
                                        class="w-full bg-surface border-2 border-secondary/20 rounded-3xl py-5 px-8 focus:ring-2 focus:ring-primary/50 focus:border-transparent transition-all text-secondary font-medium text-sm cursor-pointer">
                        ...
                        <div class="space-y-2">
                            <label class="text-xs font-bold text-secondary/70 ml-4 uppercase tracking-wider">Your Message *</label>
                            <textarea name="message" rows="6" required
                                      class="w-full bg-surface border-2 border-secondary/20 rounded-3xl py-5 px-8 focus:ring-2 focus:ring-primary/50 focus:border-transparent transition-all text-secondary font-medium text-sm resize-none"
...
{{-- ═══════════════════════════════════════════════
     MAP SECTION
═══════════════════════════════════════════════ --}}
<div class="h-[450px] w-full bg-secondary/20 relative overflow-hidden">
...
<section class="py-20 lg:py-32 bg-white">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="space-y-4">
            ...
            <details class="group bg-surface rounded-2xl border border-secondary/20 overflow-hidden hover:border-primary/20 transition-colors">
                <summary class="flex items-center justify-between cursor-pointer p-6 font-bold text-secondary text-sm">
                    <span>{{ $question }}</span>
                    <i class="fas fa-chevron-down text-primary text-xs group-open:rotate-180 transition-transform"></i>
                </summary>
                <div class="px-6 pb-6 text-secondary/70 text-sm leading-relaxed">
                    {{ $answer }}
                </div>
            </details>
            @endforeach
        ...
        <div class="mt-12 text-center p-8 bg-primary/5 rounded-3xl border border-primary/10">
            <p class="text-secondary/80 font-medium mb-4">Still have questions?</p>
            <p class="text-secondary/70 text-sm mb-6">Can't find the answer you're looking for? Our support team is here to help.</p>
